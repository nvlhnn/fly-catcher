...
async def count_endpoint(
    ...
    peak_thresh: float = Form(0.33),
    min_support_area: int = Form(6),
    min_blob_area: int = Form(1),
    ...
    use_pad_crop: bool = Form(True),
    pad_crop_margin_px: int = Form(6),
    ...
    count, marked, _ = detect_dark_blobs(
        ...
        use_pad_crop=use_pad_crop,
        pad_crop_margin_px=pad_crop_margin_px,
...
async def debug_endpoint(
    ...
    count, marked, dbg = detect_dark_blobs(
        img, annotate=True,
        bg_kernel=bg_kernel, peak_thresh=peak_thresh,
        min_support_area=min_support_area, min_blob_area=min_blob_area,
        use_red_suppression=use_red_suppression,
        ...
        use_pad_crop=use_pad_crop, pad_crop_margin_px=pad_crop_margin_px,
    ...
    payload = {
        ...
        "preview": {
            ...
            "auto_crop_x": [dbg["x_start"], dbg["x_end"]],
            "pad_mask": b64png(dbg["pad_mask"]),
        },
        "params": {
